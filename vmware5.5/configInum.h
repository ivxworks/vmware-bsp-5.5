/* configInum.h - PC Pentium4 Interrupt Number configuration header */
...
--------------------
01b,14jun02,rhe  Add C++ Protection
...
#if	(CPU == PENTIUM2) || (CPU == PENTIUM3) || (CPU == PENTIUM4) /* P6,P7 */

#if	defined(VIRTUAL_WIRE_MODE) || defined(SYMMETRIC_IO_MODE)
#   define INCLUDE_APIC_TIMER	/* include Local APIC timer */
#   if (CPU == PENTIUM2) || (CPU == PENTIUM3) /* P6 */
#       define APIC_TIMER_CLOCK_HZ  133000000 /* base/bus clock: 66/100/133M */
#   else				      /* P7 */
#       define APIC_TIMER_CLOCK_HZ  133000000 /* base/bus clock: 133/400M */
#   endif /* (CPU == PENTIUM2) || (CPU == PENTIUM3) */
...
#endif	/* (CPU == PENTIUM2) || (CPU == PENTIUM3) || (CPU == PENTIUM4) */
...
#else	/* ! SYMMETRIC_IO_MODE = (VIRTUAL_WIRE_MODE) || (PIC_MODE) */
